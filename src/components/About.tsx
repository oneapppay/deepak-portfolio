    ...
    <section className="section" id="about" aria-labelledby="about-title">
      <div className="container">
        <div className="section-head">
          ...
          />
          <p>
            Sr. DevOps / Cloud Engineer focused on AWS, Azure, Terraform, Kubernetes,
            and regulated platform operations.
          </p>
        </div>
        <div className="about-layout">
          <div className="about-copy">
            ...
            <p>{profile.about}</p>
            <p>
              The through-line across banking, public health, and EdTech is the same:
              make environments repeatable, make releases boring, and give operators a
              clear signal when something drifts.
            </p>
